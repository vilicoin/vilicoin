...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vilicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vilicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vilicoin transaction") + "\n" +
              "  vilicoin-tx [options] -create [commands]   " + _("Create hex-encoded vilicoin transaction") + "\n" +
              "\n";
