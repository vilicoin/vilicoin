...
*Setup instructions for a Gitian build of Vilicoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Vilicoin
...
[vilicoin/gitian.sigs.ltc](https://github.com/vilicoin/gitian.sigs.ltc/) repository, or if that's not possible create a pull
