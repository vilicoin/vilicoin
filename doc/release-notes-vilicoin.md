Vilicoin Core version *0.15.1* is now available from:

  <https://download.vilicoin.org/vilicoin-0.15.1/>
...
A number of changes to the way Vilicoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 namvili per kB (0.00001 VILI). This is to prepare for dropping the minimum transaction fee to 0.1 namvili per kB (0.0001 VILI) in the next release.
